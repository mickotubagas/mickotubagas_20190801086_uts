...
import 'package:mickotubagas_20190801086_uts/main.dart';
...
import 'package:mickotubagas_20190801086_uts/drag.dart';
import 'package:mickotubagas_20190801086_uts/profile.dart';
import 'package:mickotubagas_20190801086_uts/keranjang.dart';
...
class BottomBar extends StatelessWidget {
  ...
  Container totalHarga(List<PanganItem> panganItems) {
    var ConvertToIDR = new NumberFormat.currency(locale: 'id', symbol: 'Rp',
        decimalDigits: 0);
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Text(ConvertToIDR.format(int.parse(returnTotalHarga(panganItems))),
  ...
  String returnTotalHarga(List<PanganItem> panganItems) {
    ...
    for (int i = 0; i < panganItems.length; i++) {
      totalAmount = totalAmount + panganItems[i].price * panganItems[i].quantity;
    }
    return totalAmount.toStringAsFixed(totalAmount.truncateToDouble()
        == totalAmount ? 0 : 1);
  }
    ...
    return Container(
      ...
      child: InkWell(
        child: Row(
          ...
          children: <Widget>[
            Text( "Mulai Pesan",  style: TextStyle(
                fontWeight: FontWeight.w900,
                fontSize: 16, fontFamily: 'jaapokkienchance'),
            ),
          ],
        ),
        onTap: (){
          CoolAlert.show(
            ...
            onConfirmBtnTap: () {
              Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder:
                  (context) => MyApp()), (Route <dynamic> route) => false,
              );
            },
          );
        },
          ...
          children: <Widget>[
            ...
            StreamBuilder(
              ...
              builder: (context, snapshot) {
                List<PanganItem> panganItems = snapshot.data;
