...
class KeranjangProvider {
  ...
  void increaseItemQuantity(PanganItem panganItem) => panganItem.incrementQuantity();
  void decreaseItemQuantity(PanganItem panganItem) => panganItem.decrementQuantity();
}