    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.data != null) {
          ...
          return Container(
            child: Text("Kerajang anda kosong", style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          Expanded(
            flex: 1,
            child: panganItems.length > 0 ? panganItemList() : noItemContainer(),
          )
        ],
      ),
    );
      ...
      child: Center(
        child: Text(
          ...
          style: TextStyle(
              ...
              fontSize: 20, fontFamily: 'jaapokkienchance'),
        ),
      ),
    );
  }
            ...
            children: <Widget>[
              Text(
                ...
                style: TextStyle(
                  ...
                  fontSize: 35, fontFamily: 'jaapokkienchance',
                ),
              ),
              Text(
                "Pesanan Anda",
...
class KeranjangListItem extends StatelessWidget {
  ...
  KeranjangListItem({@required this.panganItem});
  @override
  Widget build(BuildContext context) {
    return LongPressDraggable(
      ...
      childWhenDragging: panganItem.quantity > 1 ? DraggableChild(panganItem: panganItem) : Container(),
    ...
    return Container(
      child: Row(
        ...
        children: <Widget>[
          ...
          RichText(
            text: TextSpan(
                style: TextStyle(
                    ...
                    fontWeight: FontWeight.w700, fontFamily: 'jaapokkienchance'),
                children: [
                  TextSpan(
                    text: panganItem.quantity.toString()
                    ),
          ...
          Text(NumberFormat.currency(locale: 'id', symbol:
          'Rp', decimalDigits: 0).format(panganItem.quantity * panganItem.price),
            style:
